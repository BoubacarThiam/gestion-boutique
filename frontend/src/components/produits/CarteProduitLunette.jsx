 ...
 * survol de ImageProduit se déclenche de façon fiable. Le tilt 3D est posé
 * sur un <motion.div> englobant : GlowCard suit déjà le curseur pour son
 * propre halo (document.pointermove), pas de conflit avec ce survol-ci.
 */
